...
Search Engine Optimiation (hereafter just "SEO") is an incredibly important aspect of modern web development to get correct. You want as many users as possible, and users typically get routed from search engines like Google and allegedly Bing.
