...
<Alert type="info">For this training, we will be proving a Drupal instance already pre-configured for each one of the attendees.</Alert>
...
<Alert type="info">
  Note: you can check out <code>gatsby-config.js</code> for further info to see how these environment variables are used.
</Alert>
...
<Alert type="info">If on a non-Unix OS, just create the file with your IDE or Explorer!</Alert>
